...
Public Class ProductManager
    ...
    Sub addProduct(ByVal product As Product)
        query = "INSERT INTO produit(code, name, prix_achat, prix_vente, description, status, quantite) values(@val1, @val2, @val3, @val4, @val5, @val6, @val7)"
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@val4", CInt(product.getPrixDeVente))
            cmd.Parameters.AddWithValue("@val5", product.getDescription)
            cmd.Parameters.AddWithValue("@val6", "En Stock")
    ...
    Public Function getProduct(ByVal index As Integer)
        ...
        Try
            ...
            While reader.Read
                ...
                EditProduct.PRIX_ACHAT.Text = reader.GetString("prix_achat")
                EditProduct.PRIX_VENTE.Text = reader.GetString("prix_vente")
                ...
                loadProduct.setPrixAchat(CInt(reader.GetString("prix_achat")))
                loadProduct.setPrixDeVent(CInt(reader.GetString("prix_vente")))
    ...
    Public Function getProductByCode(code As String) As Product
        ...
        Try
            ...
            If reader IsNot Nothing Then
                ...
                produit.setPrixAchat(CInt(reader.GetString("prix_achat")))
                produit.setPrixDeVent(CInt(reader.GetString("prix_vente")))
                produit.setQuantite(CInt(reader.GetString("quantite")))
                produit.setDescription(reader.GetString("description"))
    ...
    Public Sub edditProduct(ByVal product As Product)
        query = "UPDATE produit SET code = @val1, name = @val2, prix_achat = @val3, prix_vente = @val4, description = @val5 WHERE id = @val6"
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@val4", CInt(product.getPrixDeVente))
            cmd.Parameters.AddWithValue("@val5", product.getDescription)
            cmd.Parameters.AddWithValue("@val6", CInt(product.getId))
...
#Region "Private sub and function"
        ...
        Try
            ...
            While reader.Read
                MainController.PRODUCT_DATA_GRID.Rows.Add(reader.GetString("id"), reader.GetString("code"),
                                                          reader.GetString("name"), reader.GetString("prix_achat"),
                                                          reader.GetString("prix_vente"), reader.GetString("description"),
                                                          reader.GetString("status"), reader.GetString("quantite"))
            End While
        Catch ex As Exception
            MsgBox("Erreur de commande. Source erreur: " & ex.ToString)
        Finally
    ...
    Public Function rechercheFilter(text As String) As List(Of Product)
        ...
        Try
            ...
            reader = cmd.ExecuteReader
            While reader.Read
                mListOfProduct.Add(New Product(reader.GetString("code"), reader.GetString("name"), reader.GetString("prix_achat"), reader.GetString("prix_vente"), reader.GetString("description")))
            End While
        Catch ex As Exception
